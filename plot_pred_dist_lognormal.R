...
in1 <- "C:/Users/andre/Dropbox/sub-beta-stacy/results/nonparam - lognormal/melanoma_gender_m1_lognormal.RData"
in2 <- "C:/Users/andre/Dropbox/sub-beta-stacy/results/nonparam - lognormal/melanoma_gender_m1000_lognormal.RData"
in3 <- "C:/Users/andre/Dropbox/sub-beta-stacy/results/nonparam - lognormal/melanoma_gender_m1e6_lognormal.RData"
...
pdf("d:/pred_dist_lognormal.pdf",height = 3,width = 7)
par(mfcol=c(1,3))
par(mar=c(4,4,3,1))
...
pdf("d:/pred_dist_lognormal_F.pdf",height = 3,width = 7)
par(mfcol=c(1,3))
par(mar=c(4,4,3,1))
main <- expression(bold(log[10](m)==0))
...
#save.image("C:/Users/andre/Dropbox/sub-beta-stacy/results/plot_pred_dist_lognormal.Rdata")
#load("C:/Users/andre/Dropbox/sub-beta-stacy/results/plot_pred_dist_lognormal.Rdata")
